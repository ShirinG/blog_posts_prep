...
feature_imp <- function(model, title) {
  ...
  importance_df_1 <- importance_df_1[order(importance_df_1$Overall, decreasing = T), ]
  importance_df_1 <- importance_df_1[1:5, ]
  
  importance_df_1$group <- factor(importance_df_1$group, levels = importance_df_1$group[order(importance_df_1$Overall)])
